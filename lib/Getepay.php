...
/**
 * Getepay
 * used to manage Getepay API calls
 * 
 */
...
Class Getepay
{
	 ...
	 function __construct($client_id,$client_secret,$test_mode)
	{
		...
		if($test_mode)
			$this->api_endpoint  = "https://test.getepay.com/v2/";
		else
			$this->api_endpoint  = "https://www.getepay.com/v2/";
		if($test_mode)
			$this->auth_endpoint = "https://test.getepay.com/oauth2/token/";
		else
			$this->auth_endpoint = "https://www.getepay.com/oauth2/token/"; 
